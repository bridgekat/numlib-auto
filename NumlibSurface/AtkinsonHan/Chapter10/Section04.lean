...
with the global interpolation error estimate of §10.3 (Theorem 10.3.9), whose *abstract* half —
Galerkin solutions on a monotone family of subspaces with dense union converge — is already
`Chapter09.corollary_9_1_4`. The elementwise interpolation estimates of §10.3 (Theorems 10.3.3,
10.3.5, Corollary 10.3.7) are proved on reference elements that are Sobolev extension domains;
what is missing for 10.4.1 is the triangulation scaffold behind Theorem 10.3.9 — the global
interpolant, its conformity and the additivity of the norm over the elements (`notes/frontier.md`,
blocker 11).  The abstract half of Corollary 10.4.4, in which the approximation power of the dual
...
Proposition 10.2.1) and `Chapter10.Section03` (Theorems 10.3.1, 10.3.3, 10.3.4, 10.3.5,
Corollary 10.3.7, Example 10.3.2, Definition 10.3.6, Example 10.3.8 on the unit square).
-/
