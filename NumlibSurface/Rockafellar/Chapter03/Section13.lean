...
Surface file for R. Tyrrell Rockafellar, *Convex Analysis*, Princeton University Press, 1970, §13:
...
of `dom f`, `dom f*` and of a level set `{x | f x ≤ 0}` from the conjugate `f*`.

All 15 numbered results of §13 are formalized. Theorem 13.2's bijection is
`theorem_13_2_correspondence`.
...
* `theorem_13_1_cl`, `theorem_13_1_ri`, `theorem_13_1_int`, `theorem_13_1_aff`,
  `corollary_13_1_1` — membership in `cl C`, `ri C`, `int C` and `aff C` read off from the support
  function, and the comparison `cl C₁ ⊆ cl C₂ ↔ δ*(· | C₁) ≤ δ*(· | C₂)`.
* `theorem_13_2`, `theorem_13_2_conj`, `theorem_13_2_conj_indicator`,
  `theorem_13_2_correspondence`, `theorem_13_2_subadditive`, `corollary_13_2_1`,
  `corollary_13_2_2` — indicator and support function are conjugate, and support functions of
  non-empty convex sets are exactly the closed proper positively homogeneous convex functions,
  giving the one-to-one correspondence with closed convex sets.
* `theorem_13_3`, `theorem_13_3_dual`, `corollary_13_3_1`, `corollary_13_3_2`,
  `corollary_13_3_3`, `corollary_13_3_3_least`, `corollary_13_3_3_finite`, `corollary_13_3_4_a`
  through `corollary_13_3_4_d` — the support function of `dom f` is `f*0⁺` and that of `dom f*` is
  `f0⁺`, with the boundedness and Lipschitz consequences.
* `theorem_13_4`, `theorem_13_4_dual`, `theorem_13_4_lineality`, `theorem_13_4_dimension`,
  `corollary_13_4_1`, `corollary_13_4_2` — the lineality space of `f` and the affine hull of
  `dom f*` are orthogonal complements, and the two dimension formulas that follow.
* `theorem_13_5`, `theorem_13_5_dual`, `corollary_13_5_1` — the support function of the level set
  `{x | f x ≤ 0}`, and the positively homogeneous convex function generated by `f*`.

**The interior clause of Theorem 13.1 needs `C ≠ ∅`**, which the book omits: over the zero space
the stated condition is vacuously true while `int ∅ = ∅`. `theorem_13_1_int` carries it.
-/
