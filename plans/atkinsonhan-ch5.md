...
Proposed files (`NumlibSurface/AtkinsonHan/Chapter05/`, namespace `AtkinsonHan.Chapter05`, one section per file):
...
These are open nodes of the plan now: item 1 is `Numlib/IntegralEquations/Basic.toml`, item 2 the
Kantorovich and chord-method nodes appended to `Numlib/Nonlinear/Newton.toml`, item 3
`Numlib/Krylov/Convergence/Superlinear.toml` (with the eigenbasis as data, as the variant below
recommends); the surface results are `theorem_5_2_2`–`theorem_5_2_4`, `theorem_5_4_2_sharp`,
`exercise_5_4_5` and `theorem_5_6_2` in their section groups.
