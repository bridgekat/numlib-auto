...
Now the open nodes `IsPetrovGalerkinSolution.projection` and
`IsPetrovGalerkinSolution.norm_sub_le_div_mul_infDist` of `Numlib/Variational/Galerkin.toml`, with
the surface node `remark_9_2_2`.
