...
Specification-level versions of [fong2012cg] Thm 2.3–2.5 and Thm 3.1: for *any* sequence of
...
[steihaug1983conjugate] and tabulated as the CG column of [fong2012cg] Table 5.1, and `‖x* - x_k‖`
is nonincreasing, [hestenes1952methods] Thm 6:3.
-/
...
/-- [steihaug1983conjugate], *The conjugate gradient method and trust regions in large scale
optimization* (tabulated as the CG column of [fong2012cg], Table 5.1): `‖x_k‖` is nondecreasing (`x₀
= 0`). -/
...
/-- [hestenes1952methods], *Methods of conjugate gradients for solving linear systems*, Thm 6:3:
