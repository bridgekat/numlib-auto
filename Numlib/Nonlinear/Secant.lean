...
-- TODO(orchestrator): the two mean value facts of this section are general facts about `C¹`
-- and `C²` functions and want a calculus home; they should move together, since the second is
-- the three-node analogue of the first. Natural home `Numlib/Analysis/Calculus`.
