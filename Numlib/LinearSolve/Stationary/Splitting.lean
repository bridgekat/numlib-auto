...
/-- The generic shape of every `M` below: a scaled diagonal plus a scaled strictly triangular
part is a unit as soon as the scaling of the diagonal and the diagonal of `A` are nonzero. -/
